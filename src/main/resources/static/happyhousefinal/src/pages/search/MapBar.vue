  ...
  methods: {
        ...
        .then(response => {
          ...
          response.data.forEach(vo => {
            ...
            tmp = new kakao.maps.Marker({
              position: new kakao.maps.LatLng(parseFloat(vo.lat), parseFloat(vo.lng)),
            ...
            kakao.maps.event.addListener(tmp, 'mouseout', this.makeOutListener(infowindow));
            ...
            geocoder.addressSearch(element.WRKP_ADDR, function(result, status) {
              ...
              if (status === kakao.maps.services.Status.OK) {
                if (tmpDong == result[0].address.region_3depth_name) {
                  ...
                  kakao.maps.event.addListener(tmp, 'mouseover', makeover(map2, tmp, infowindow));
                  kakao.maps.event.addListener(tmp, 'mouseout', makeout(infowindow));
                  //
                  //   alert("wow");
                  tmp.setMap(map2);
    ...
    guMethod(gugu) {
      ...
      if (gugu == '11320') {
        ...
        axios
          ...
          .then(response => (this.envirList = response.data.YdpListEnvGuideCheck.row));
      } else if (gugu == '11740') {
        //강동구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.GdListEnvGuideCheck.row));
      } else if (gugu == '11680') {
        //강남구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.GnListEnvGuideCheck.row));
      } else if (gugu == '11200') {
        //"성동구"
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.SdListEnvGuideCheck.row));
      } else if (gugu == '11410') {
        //서대문구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.SeodaemunListEnvGuideCheck.row));
      } else if (gugu == '11440') {
        //마포구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.MpListEnvGuideCheck.row));
      } else if (gugu == '11290') {
        //"성북구"
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.SbListEnvGuideCheck.row));
      } else if (gugu == '11650') {
        //서초구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.ScListEnvGuideCheck.row));
      } else if (gugu == '11590') {
        //동작구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.DjListEnvGuideCheck.row));
      } else if (gugu == '11710') {
        //송파구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.SpListEnvGuideCheck.row));
      } else if (gugu == '11470') {
        //양천구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.YcListEnvGuideCheck.row));
      } else if (gugu == '11230') {
        //"동대문구"
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.DongdeamoonListEnvGuideCheck.row));
      } else if (gugu == '11350') {
        //노원구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.NwListEnvGuideCheck.row));
      } else if (gugu == '11170') {
        //"용산구"
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.YsListEnvGuideCheck.row));
      } else if (gugu == '11215') {
        //"광진구"
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.GwangjinListEnvGuideCheck.row));
      } else if (gugu == '11500') {
        //강서구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.GangseoListEnvGuideCheck.row));
      } else if (gugu == '11545') {
        //금천구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.GeumcheonListEnvGuideCheck.row));
      } else if (gugu == '11260') {
        //"중랑구"
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.JungnangListEnvGuideCheck.row));
      } else if (gugu == '11620') {
        //관악구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.GaListEnvGuideCheck.row));
      } else if (gugu == '11380') {
        //은평구
        axios
          .get(
          ...
          .then(response => (this.envirList = response.data.EpListEnvGuideCheck.row));
      } else {
        alert('에러!');
      }
      //  alert("end");
    ...
    addMarkers2(data) {
      ...
      data.forEach(vo => {
        ...
        //
        var infowindow = new kakao.maps.InfoWindow({
          content: '<div>' + vo.aptName + '</div>' + '<div> 거래가격 : ' + vo.dealAmount + '</div>', // 인포윈도우에 표시할 내용
        });
    ...
    addMarkers(vo) {
      ...
      kakao.maps.event.addListener(this.marker, 'mouseout', this.makeOutListener(infowindow));
      //
