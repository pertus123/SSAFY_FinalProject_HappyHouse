...
<nav class="navbar navbar-expand-lg">
        <!-- Brand/logo -->
        <a class="navbar-brand" href="${root}"> <img src="${root}/img/logo.png" alt="logo" style="width: 150px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="navbar-nav">
                <li class="nav-item ">
                    <h5><a class="nav-link" href ="${root}/member/userInform">내 정보 수정</a></h5>
                </li>
                <li class="nav-item">
                    <h5><a class="nav-link" href ="${root}/member/interestloc">관심 지역</a></h5>
                </li>
                <li class="nav-item">
                    <h5><a class="nav-link" href ="${root}/member/interestdeal">관심 매물</a></h5>
                </li>
            </ul>
            <div class="hb ml-auto custom-header">
                ...
                <button id="logout" class="navbar-nav btn btn-secondary btn-sm" onclick="location.href='${root}/member/logout'"
